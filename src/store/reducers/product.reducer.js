...
const initialState = {
     products:[
        ...
        { _id: 2, name: 'Yoga Block', price: '45', imgUrl: 'public/img/yoga-block.jpg', description: 'Supportive yoga block to enhance your practice.', category: 'accessories' },
        { _id: 3, name: 'Yoga Strap', price: '30', imgUrl: 'public/img/yoga-strap.jpg', description: 'Durable yoga strap for better stretching.', category: 'accessories' },
        { _id: 4, name: 'Yoga Pants- Red', price: '150', imgUrl: 'public/img/yoga-pants-red.jpg', description: 'Yoga wheel to improve flexibility and balance.', category: 'accessories' },
        ...
        { _id: 8, name: 'Yoga Pants- Grey', price: '130', imgUrl: 'public/img/grey-yoga-pants.jpg', description: 'Supportive bolster for restorative yoga.', category: 'accessories' },
        ...
        { _id: 10, name: 'Yoga Cushion', price: '70', imgUrl: 'public/img/yoga-cushion.jpg', description: 'Soft blanket for added comfort.', category: 'accessories' },
        { _id: 11, name: 'Yoga Blanket', price: '90', imgUrl: 'public/img/yoga-blanket.jpg', description: 'Stability ball for core exercises.', category: 'accessories' },
        { _id: 12, name: 'Timer', price: '200', imgUrl: 'public/img/sand-timer.jpg', description: 'Chair designed for yoga practice.', category: 'accessories' },
